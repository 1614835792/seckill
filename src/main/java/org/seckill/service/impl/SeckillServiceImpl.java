...
public class SeckillServiceImpl implements SeckillService {
    ...
    //md5盐值字符串，用来混淆md5
    private final String slat="safwwerdqeas*&&^&^@#kedk2";
    @Override
    ...
    2：保证事务方法的执行时间尽可能短，不要穿插其他网络操作请求或者事务方法外部
    ...
    public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5) throws SeckillException, RepeatKillException, SeckillException {
       try{
           ...
           if(insertCount<=0){
               ...
               int updateCount=seckillDao.reduceNumber(seckillId,newTime);
               if(updateCount<=0){
                   //没有更新到记录,秒杀结束
